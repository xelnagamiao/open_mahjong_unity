...
export const GUOBIAO = [
  ...
  { id: 'guobiao:jiulianbaodeng', names: ['九莲宝灯'], rules: ['guobiao'], types: ['特殊系'], reqLength: 1, fan: 88, relatedIds: ['riichi:chuurenpoutou'] },
  ...
  { id: 'guobiao:shisanyao', names: ['十三幺'], rules: ['guobiao'], types: ['特殊系'], reqLength: 1, fan: 88, relatedIds: ['riichi:kokushi'] },
  { id: 'guobiao:qingyaojiu', names: ['清幺九'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 64, relatedIds: ['riichi:chinroutou'] },
  { id: 'guobiao:xiaosixi', names: ['小四喜'], rules: ['guobiao'], types: ['刻子系'], reqLength: 4, fan: 64, relatedIds: ['riichi:shousuushi', 'guobiao:dasixi', 'riichi:daisushi'] },
  { id: 'guobiao:xiaosanyuan', names: ['小三元'], rules: ['guobiao'], types: ['刻子系'], reqLength: 3, fan: 64, relatedIds: ['riichi:shousangen', 'guobiao:dasanyuan', 'riichi:daisangen'] },
  { id: 'guobiao:ziyise', names: ['字一色'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 64, relatedIds: ['riichi:tsuuiisou'] },
  { id: 'guobiao:sianke', names: ['四暗刻'], rules: ['guobiao'], types: ['刻子系'], reqLength: 4, fan: 64, relatedIds: ['riichi:suuankou', 'guobiao:sananke', 'riichi:sanankou'] },
  { id: 'guobiao:yiseshuanglonghui', names: ['一色双龙会'], rules: ['guobiao'], types: ['条件系'], reqLength: 4, fan: 64, relatedIds: [] },
  ...
  { id: 'guobiao:quanda', names: ['全大', '全中', '全小'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 24, relatedIds: ['guobiao:quanzhong', 'guobiao:quanxiao'] },
  { id: 'guobiao:quanzhong', names: ['全中', '全大', '全小'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 24, relatedIds: ['guobiao:quanda', 'guobiao:quanxiao'] },
  { id: 'guobiao:quanxiao', names: ['全小', '全大', '全中'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 24, relatedIds: ['guobiao:quanda', 'guobiao:quanzhong'] },
  ...
  { id: 'guobiao:sananke', names: ['三暗刻'], rules: ['guobiao'], types: ['刻子系'], reqLength: 3, fan: 16, relatedIds: ['riichi:sanankou', 'guobiao:sianke', 'riichi:suuankou'] },
  ...
  { id: 'guobiao:miaoshouhuichun', names: ['妙手回春', '海底捞月', '河底捞鱼'], rules: ['guobiao'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 8, relatedIds: ['guobiao:haidilaoyue', 'riichi:haitei', 'riichi:houtei'] },
  { id: 'guobiao:haidilaoyue', names: ['海底捞月', '河底捞鱼', '妙手回春'], rules: ['guobiao'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 8, relatedIds: ['guobiao:miaoshouhuichun', 'riichi:haitei', 'riichi:houtei'] },
  ...
  { id: 'guobiao:jianke', names: ['箭刻'], rules: ['guobiao'], types: ['刻子系'], reqLength: 1, fan: 2, relatedIds: ['riichi:yakuhai'] },
  { id: 'guobiao:quanfengke', names: ['圈风刻'], rules: ['guobiao'], types: ['刻子系'], reqLength: 1, fan: 2, relatedIds: ['riichi:bakaze'] },
  { id: 'guobiao:menfengke', names: ['门风刻'], rules: ['guobiao'], types: ['刻子系'], reqLength: 1, fan: 2, relatedIds: ['riichi:jikaze'] },
  { id: 'guobiao:menqianqing', names: ['门前清'], rules: ['guobiao'], types: ['条件系'], reqLength: '全体', fan: 2, relatedIds: ['riichi:menzen_tsumo'] },
  { id: 'guobiao:pinghe', names: ['平和'], rules: ['guobiao'], types: ['条件系'], reqLength: 4, fan: 2, relatedIds: ['riichi:pinfu'] },
...
const RIICHI = [
  ...
  { id: 'riichi:pinfu', names: ['平和'], rules: ['riichi'], types: ['条件系'], reqLength: 4, fan: 1, relatedIds: ['guobiao:pinghe'] },
  ...
  { id: 'riichi:yakuhai', names: ['役牌'], rules: ['riichi'], types: ['刻子系'], reqLength: 1, fan: 1, relatedIds: ['guobiao:jianke'] },
  { id: 'riichi:jikaze', names: ['自风'], rules: ['riichi'], types: ['刻子系'], reqLength: 1, fan: 1, relatedIds: ['guobiao:menfengke'] },
  { id: 'riichi:bakaze', names: ['场风'], rules: ['riichi'], types: ['刻子系'], reqLength: 1, fan: 1, relatedIds: ['guobiao:quanfengke'] },
  ...
  { id: 'riichi:haitei', names: ['海底捞月', '河底捞鱼', '妙手回春'], rules: ['riichi'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 1, relatedIds: ['guobiao:haidilaoyue', 'riichi:houtei', 'guobiao:miaoshouhuichun'] },
  { id: 'riichi:houtei', names: ['河底捞鱼', '海底捞月', '妙手回春'], rules: ['riichi'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 1, relatedIds: ['guobiao:haidilaoyue', 'riichi:haitei', 'guobiao:miaoshouhuichun'] },
  { id: 'riichi:dora', names: ['宝牌', '赤宝牌', '里宝牌'], rules: ['riichi'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 1, relatedIds: ['riichi:aka_dora', 'riichi:ura_dora'] },
  { id: 'riichi:aka_dora', names: ['赤宝牌', '宝牌', '里宝牌'], rules: ['riichi'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 1, relatedIds: ['riichi:dora', 'riichi:ura_dora'] },
  { id: 'riichi:ura_dora', names: ['里宝牌', '宝牌', '赤宝牌'], rules: ['riichi'], types: ['条件系', '偶然系'], reqLength: '条件', fan: 1, relatedIds: ['riichi:dora', 'riichi:aka_dora'] },
  ...
  { id: 'riichi:sanankou', names: ['三暗刻'], rules: ['riichi'], types: ['刻子系'], reqLength: 3, fan: 2, relatedIds: ['guobiao:sananke', 'riichi:suuankou', 'guobiao:sianke'] },
  { id: 'riichi:shousangen', names: ['小三元'], rules: ['riichi'], types: ['刻子系'], reqLength: 3, fan: 2, relatedIds: ['guobiao:xiaosanyuan', 'riichi:daisangen', 'guobiao:dasanyuan'] },
  ...
  { id: 'riichi:daisangen', names: ['大三元'], rules: ['riichi'], types: ['刻子系'], reqLength: 3, fan: '役满', relatedIds: ['guobiao:dasanyuan', 'riichi:shousangen', 'guobiao:xiaosanyuan'] },
  { id: 'riichi:suuankou', names: ['四暗刻'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '役满', relatedIds: ['guobiao:sianke', 'riichi:sanankou', 'guobiao:sananke'] },
  ...
  { id: 'riichi:shousuushi', names: ['小四喜'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '役满', relatedIds: ['guobiao:xiaosixi', 'riichi:daisushi', 'guobiao:dasixi'] },
  ...
  { id: 'riichi:daisushi', names: ['大四喜'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '役满', relatedIds: ['guobiao:dasixi', 'riichi:shousuushi', 'guobiao:xiaosixi'] },
  { id: 'riichi:nagashi_mangan', names: ['流局满贯'], rules: ['riichi'], types: ['条件系'], reqLength: '条件', fan: '满贯', relatedIds: [] },
]

/** @type {GuessFan[]} */
export const GUESS_FAN_CATALOG = [...GUOBIAO, ...RIICHI].map((fan) => ({
  ...fan,
  reqLength: fan.reqLength === '条件' ? 0 : fan.reqLength,
}))

/** @type {Record<string, GuessFan>} */
export const GUESS_FAN_BY_ID = Object.fromEntries(GUESS_FAN_CATALOG.map((f) => [f.id, f]))
 ...
 * @returns {GuessFan[]}
 */
export function filterCatalogByRules(rules) {
 ...
 */
export function rollAnswer(rules) {
 ...
 */
export function findFanByName(name, preferredRules = ['guobiao', 'riichi']) {
...
export function hasSingleFanAtLeast(fanNames, cutoff, rule = 'guobiao') {
  ...
  return fanNames.some((label) => {
    ...
    return values.some((value) => Number(value) >= cutoff)
  })
}
 ...
 * @param {number} [limit]
 */
export function suggestFans(query, rules, limit = 12) {
  ...
  for (const f of pool) {
    ...
    for (const n of f.names) {
      ...
      const fullPinyin = pinyin(n, { toneType: 'none', type: 'array' }).join('').toLowerCase()
      const initials = pinyin(n, { pattern: 'first', toneType: 'none', type: 'array' }).join('').toLowerCase()
      if (normalizedName === q || fullPinyin === q) score = Math.max(score, 100)
      else if (normalizedName.startsWith(q) || fullPinyin.startsWith(q)) score = Math.max(score, 80)
      else if (initials.startsWith(q)) score = Math.max(score, 70)
      else if (normalizedName.includes(q) || fullPinyin.includes(q)) score = Math.max(score, 50)
    }
 ...
 */
export function formatFanDisplay(fan) {
 ...
 */
export function formatFanField(fan) {
