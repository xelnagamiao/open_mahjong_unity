...
public class CreatePanel : MonoBehaviour {
    ...
    private const string CfgCsHeavenEarthHu = "cs_heaven_earth_hu";
    ...
    private Toggle ChangshaHeavenEarthHuToggle;
    ...
    private void SetConfigValue(string key, object value) {
        switch (key) {
            ...
            case CfgCsHeavenEarthHu: if (ChangshaHeavenEarthHuToggle != null) ChangshaHeavenEarthHuToggle.isOn = (bool)value; break;
    ...
    private void EnsureChangshaOptionControls() {
        ...
        ChangshaHeavenEarthHuToggle = EnsureClonedToggle(toggleTemplate, ChangshaHeavenEarthHuToggle, "ChangshaHeavenEarthHu", "天地胡", false);
        ...
        ConfigureChangshaToggle(ChangshaHeavenEarthHuToggle, ChangshaRuleOptionRow.transform);
    ...
    private void CreateChangshaRoom() {
        var config = new Changsha_Create_RoomConfig {
            ...
            HeavenEarthHu = ChangshaHeavenEarthHuToggle != null && ChangshaHeavenEarthHuToggle.isOn,
