...
const GUOBIAO = [
  ...
  { id: 'guobiao:sianke', names: ['四暗刻'], rules: ['guobiao'], types: ['刻子系'], reqLength: 4, fan: 64, relatedIds: ['riichi:suuankou'] },
...
const RIICHI = [
  ...
  { id: 'riichi:daisushi', names: ['大四喜'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '役满', relatedIds: ['guobiao:dasixi'] },
