...
{
    /// <summary>
    /// Fan tile 3T - at least 3 fan tiles have triplets (count >= 3).
    /// C++ ref: inline res_t fan_tile_3t(const hand& h)
    /// Fan tiles = {seat_wind, C (Red), F (Green), P (White)}
    /// </summary>
    public class FanTile3TCriterion : IQingqueCriterion
    {
        public QingqueFan Fan => QingqueFan.FanTile3T;
