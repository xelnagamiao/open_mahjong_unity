...
额外的版权声明与许可：
只要本词条仍然存在，Resources文件夹中的任意资源都可以在非商业形式、用于本项目的情况下进行使用与修改，这一声明超出上述许可证限制，这代表如果您部署时不考虑任何商业用途，就自动拥有了Resources下任意资源的使用和修改权；如果在未来添加了一些不能被直接使用的美术素材，我会在本词条下进行额外补充和说明，在默认部署的情况下也会不启用这些有版权问题的素材，您可以放心使用。另外，某些规则的代码虽然公开，但是规则的发明者仍然拥有玩法本身的著作权，如果您部署的平台与规则创作者之间产生了某些争议，创作者可能会要求您关闭某几个规则的对外服务，这一点我们无能为力，希望可以理解。
...
*最后更新：2026年2月17日 dev ver 0.3.48.12 *
