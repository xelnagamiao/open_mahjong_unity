...
class RoomManager:
    ...
    async def create_Changsha_room(self, player_id: str, room_name: str, gameround: int,
                                   ...
                                   small_hu_self_draw_only: bool = False,
                                   bird_count: int = 2,
        ...
        try:
            ...
            room_config = {
                ...
                "small_hu_self_draw_only": small_hu_self_draw_only,
            ...
            if rule == "guobiao":
                ...
                validated = self.room_validators["changsha"](
                    **base_config,
                    ...
                    small_hu_self_draw_only=bool(room_config.get("small_hu_self_draw_only", False)),
