...
public class RoomItem : MonoBehaviour {
    ...
    private void showGBInfo(int gameTime,int randomSeed,bool tips,bool openCuohe){
        // 显示游戏圈数
        if (gameTime == 1){
    ...
    private void showRiichiInfo(int gameTime,int randomSeed,bool tips,bool openCuohe){
        // 显示游戏圈数
        if (gameTime == 1){
            this.gameRound.text = $"东风战";
        } else if(gameTime == 2){
    ...
    private void showQingqueInfo(int gameTime,int randomSeed,bool tips,bool openCuohe){
        // 显示游戏圈数
        if (gameTime == 1){
            this.gameRound.text = $"东风战";
        } else if(gameTime == 2){
