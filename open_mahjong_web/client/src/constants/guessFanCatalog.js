 ...
 * @typedef {'顺子系'|'刻子系'|'对子系'|'全体系'|'全不靠系'|'条件系'|'偶然系'} FanType
 * @typedef {number|number[]|'全体'|'条件'} ReqLength
 * @typedef {{
 *   id: string,
 *   names: string[],
 *   rules: FanRule[],
...
const GUOBIAO = [
  ...
  { id: 'guobiao:jiulianbaodeng', names: ['九莲宝灯'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 88, relatedIds: ['riichi:chuurenpoutou', 'riichi:junsei_chuuren'] },
  ...
  { id: 'guobiao:shisanyao', names: ['十三幺'], rules: ['guobiao'], types: ['全不靠系'], reqLength: 1, fan: 88, relatedIds: ['riichi:kokushi', 'riichi:kokushi_13'] },
  { id: 'guobiao:qingyaojiu', names: ['清幺九'], rules: ['guobiao'], types: ['全体系'], reqLength: '全体', fan: 64, relatedIds: ['riichi:chinroutou'] },
  { id: 'guobiao:xiaosixi', names: ['小四喜'], rules: ['guobiao'], types: ['刻子系'], reqLength: 3, fan: 64, relatedIds: ['riichi:shousuushi'] },
  { id: 'guobiao:xiaosanyuan', names: ['小三元'], rules: ['guobiao'], types: ['刻子系'], reqLength: 2, fan: 64, relatedIds: ['riichi:shousangen'] },
  ...
  { id: 'guobiao:quandaiwu', names: ['全带五'], rules: ['guobiao'], types: ['条件系'], reqLength: '全体', fan: 16, relatedIds: [] },
  ...
  { id: 'guobiao:quanbukao', names: ['全不靠'], rules: ['guobiao'], types: ['全不靠系'], reqLength: [1, 2], fan: 12, relatedIds: [] },
  { id: 'guobiao:zuhelong', names: ['组合龙'], rules: ['guobiao'], types: ['全不靠系', '顺子系'], reqLength: 3, fan: 12, relatedIds: [] },
  ...
  { id: 'guobiao:miaoshouhuichun', names: ['妙手回春'], rules: ['guobiao'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 8, relatedIds: ['riichi:haitei'] },
  { id: 'guobiao:haidilaoyue', names: ['海底捞月'], rules: ['guobiao'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 8, relatedIds: ['riichi:haitei'] },
  { id: 'guobiao:gangshangkaihua', names: ['杠上开花'], rules: ['guobiao'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 8, relatedIds: ['riichi:rinshan'] },
  { id: 'guobiao:qiangganghe', names: ['抢杠和'], rules: ['guobiao'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 8, relatedIds: ['riichi:chankan'] },
  ...
  { id: 'guobiao:quanqiuren', names: ['全求人'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 6, relatedIds: [] },
  ...
  { id: 'guobiao:buqiuren', names: ['不求人'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 4, relatedIds: ['riichi:menzen_tsumo'] },
  { id: 'guobiao:shuangminggang', names: ['双明杠'], rules: ['guobiao'], types: ['刻子系'], reqLength: 2, fan: 4, relatedIds: [] },
  { id: 'guobiao:hejuezhang', names: ['和绝张'], rules: ['guobiao'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 4, relatedIds: [] },
  ...
  { id: 'guobiao:menqianqing', names: ['门前清'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 2, relatedIds: ['riichi:menzen_tsumo'] },
  { id: 'guobiao:pinghe', names: ['平和'], rules: ['guobiao'], types: ['顺子系'], reqLength: 4, fan: 2, relatedIds: ['riichi:pinfu'] },
  { id: 'guobiao:siguiyi', names: ['四归一'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 2, relatedIds: [] },
  ...
  { id: 'guobiao:bianzhang', names: ['边张'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 1, relatedIds: [] },
  { id: 'guobiao:qianzhang', names: ['嵌张'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 1, relatedIds: [] },
  { id: 'guobiao:dandiaojiang', names: ['单钓将'], rules: ['guobiao'], types: ['条件系'], reqLength: '条件', fan: 1, relatedIds: [] },
...
const RIICHI = [
  ...
  { id: 'riichi:rinshan', names: ['岭上开花'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 1, relatedIds: ['guobiao:gangshangkaihua'] },
  { id: 'riichi:chankan', names: ['枪杠', '抢杠'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 1, relatedIds: ['guobiao:qiangganghe'] },
  { id: 'riichi:haitei', names: ['海底捞月'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 1, relatedIds: ['guobiao:haidilaoyue', 'guobiao:miaoshouhuichun'] },
  { id: 'riichi:houtei', names: ['河底捞鱼'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 1, relatedIds: [] },
  ...
  { id: 'riichi:ura_dora', names: ['里宝牌'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 1, relatedIds: [] },
  { id: 'riichi:churou', names: ['错和'], rules: ['riichi'], types: ['条件系'], reqLength: '条件', fan: 1, relatedIds: [] },
  ...
  { id: 'riichi:shousangen', names: ['小三元'], rules: ['riichi'], types: ['刻子系'], reqLength: 2, fan: 2, relatedIds: ['guobiao:xiaosanyuan'] },
  ...
  { id: 'riichi:tenhou', names: ['天和'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: '役满', relatedIds: [] },
  { id: 'riichi:chiihou', names: ['地和'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: '役满', relatedIds: [] },
  ...
  { id: 'riichi:kokushi', names: ['国士无双'], rules: ['riichi'], types: ['全不靠系'], reqLength: 1, fan: '役满', relatedIds: ['guobiao:shisanyao'] },
  { id: 'riichi:shousuushi', names: ['小四喜'], rules: ['riichi'], types: ['刻子系'], reqLength: 3, fan: '役满', relatedIds: ['guobiao:xiaosixi'] },
  { id: 'riichi:suukantsu', names: ['四杠子'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '役满', relatedIds: ['guobiao:sigang'] },
  { id: 'riichi:chuurenpoutou', names: ['九莲宝灯'], rules: ['riichi'], types: ['全体系'], reqLength: '全体', fan: '役满', relatedIds: ['guobiao:jiulianbaodeng'] },
  { id: 'riichi:suuankou_tanki', names: ['四暗刻单骑'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '双倍役满', relatedIds: ['guobiao:sianke'] },
  { id: 'riichi:kokushi_13', names: ['国士无双十三面'], rules: ['riichi'], types: ['全不靠系'], reqLength: 1, fan: '双倍役满', relatedIds: ['guobiao:shisanyao'] },
  { id: 'riichi:junsei_chuuren', names: ['纯正九莲宝灯'], rules: ['riichi'], types: ['全体系'], reqLength: '全体', fan: '双倍役满', relatedIds: ['guobiao:jiulianbaodeng'] },
  { id: 'riichi:daisushi', names: ['大四喜'], rules: ['riichi'], types: ['刻子系'], reqLength: 4, fan: '双倍役满', relatedIds: ['guobiao:dasixi'] },
  { id: 'riichi:open_riichi', names: ['开立直'], rules: ['riichi'], types: ['条件系'], reqLength: '条件', fan: 2, relatedIds: [] },
  { id: 'riichi:double_open_riichi', names: ['双倍开立直'], rules: ['riichi'], types: ['条件系'], reqLength: '条件', fan: 3, relatedIds: [] },
  { id: 'riichi:renhou', names: ['人和'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: 5, relatedIds: [] },
  { id: 'riichi:nagashi_mangan', names: ['流局满贯'], rules: ['riichi'], types: ['条件系'], reqLength: '条件', fan: '满贯', relatedIds: [] },
  { id: 'riichi:daichisei', names: ['大七星'], rules: ['riichi'], types: ['对子系'], reqLength: 7, fan: '役满', relatedIds: [] },
  { id: 'riichi:daisharin', names: ['大车轮'], rules: ['riichi'], types: ['对子系'], reqLength: 7, fan: '役满', relatedIds: [] },
  { id: 'riichi:parenchan', names: ['八连庄'], rules: ['riichi'], types: ['偶然系', '条件系'], reqLength: '条件', fan: '役满', relatedIds: [] },
  { id: 'riichi:pao', names: ['包牌'], rules: ['riichi'], types: ['条件系'], reqLength: '条件', fan: '役满', relatedIds: [] },
]

/** @type {GuessFan[]} */
export const GUESS_FAN_CATALOG = [...GUOBIAO, ...RIICHI]
