...
public partial class GameRecordManager
{
    ...
    /// <summary>跳转重建后把中心盘分数对齐推演结果，避免杠分飘字留在「局首」。</summary>
    private void SyncRecordBoardScores() {
        if (BoardCanvas.Instance == null || recordPlayerList == null || indexToPosition == null) return;
