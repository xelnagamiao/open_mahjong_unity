...
{
    /// <summary>
    /// Fan tile 2T - at least 2 fan tiles have triplets (count >= 3).
    /// C++ ref: inline res_t fan_tile_2t(const hand& h)
    /// Fan tiles = {seat_wind, C (Red), F (Green), P (White)}
    /// </summary>
    public class FanTile2TCriterion : IQingqueCriterion
    {
        public QingqueFan Fan => QingqueFan.FanTile2T;
