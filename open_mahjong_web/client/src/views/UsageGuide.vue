            ...
            <template v-else-if="sec.id === 'guess-fan'">
              <ol class="faq-list">
                ...
                <li>
                  ...
                  <ul class="sub-list">
                    <li>
                      <strong>同义、同名关联：</strong>两个规则中的同名番，或共享同一种番型的同义番。例如答案是立直「一气通贯」，猜国标「清龙」，名字显示黄色；只有猜中题库中的那个具体番种才会绿色。又如答案「全大」番名为 [全大，全中，全小]，猜出全中时名字显示黄色。
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul class="sub-list">
                    ...
                    <li>声明特殊番种原则：四归一的组数规定为 [4、3、2]；组合龙、九莲宝灯的组数规定为 [1]；全不靠、七星不靠与一色系番种的组数规定为 [全体]；对子系的组数规定为 [7]。</li>
