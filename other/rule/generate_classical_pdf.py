...
def build_pdf(output_path: str) -> None:
    ...
    story.append(bullet("和牌玩家：直接采用其本局的和牌总副参与比较，不再被其他家征收。"))
    story.append(bullet("比较规则：若一家拥有 x 副，则所有少于 x 副且未和牌者各向其支付 x 分。"))
    ...
    story.append(bullet("数和尾结算：未和牌阶段闲家之间副差正常结算，涉及庄家时该笔转账翻倍。"))
    story.append(Paragraph(
