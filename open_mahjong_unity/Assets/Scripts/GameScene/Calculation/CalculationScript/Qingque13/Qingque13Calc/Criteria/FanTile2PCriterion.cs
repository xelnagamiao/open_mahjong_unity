...
{
    /// <summary>
    /// Fan tile 2P - at least 2 distinct fan tiles present in decomposition.
    /// C++ ref: inline res_v fan_tile_2p(const hand& h)
    /// Fan tiles = {seat_wind, C (Red), F (Green), P (White)}
    /// </summary>
    public class FanTile2PCriterion : IQingqueCriterion
    {
        public QingqueFan Fan => QingqueFan.FanTile2P;
