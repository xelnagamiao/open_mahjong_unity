...
# 和牌: [hu_class, hepai_idx, hu_score, hu_fan[], [p0Δ,p1Δ,p2Δ,p3Δ], hepai_tile?, bird_tiles[]?]（错和无 end，游戏继续）
# 流局: ["liuju"]
...
# 牌谱记录和牌 [hu_class, hepai_player_index, hu_score, hu_fan, score_changes, base_fu?, fu_fan_list?, hepai_tile?, multi_ron?, ron_discarder_index?, recycle_discard?, bird_tiles[]?]
def player_action_record_hu(self, hu_class: str, hu_score, hu_fan: list,
                            ...
                            recycle_discard=None, bird_tiles=None):
