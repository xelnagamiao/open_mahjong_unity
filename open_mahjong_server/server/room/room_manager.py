    ...
    async def create_Changsha_room(self, player_id: str, room_name: str, gameround: int,
        ...
        try:
            ...
            room_config = {
                ...
                "mid_round_four_joys": mid_round_four_joys,
                "mid_round_six_six": mid_round_six_six,
            ...
            if rule == "guobiao":
                ...
                validated = self.room_validators["changsha"](
                    **base_config,
                    ...
                    mid_round_four_joys=bool(room_config.get("mid_round_four_joys", False)),
                    mid_round_six_six=bool(room_config.get("mid_round_six_six", False)),
