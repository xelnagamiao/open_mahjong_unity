...
public static class SubRuleDescriptionDictionary {
    public static readonly Dictionary<string, string> Descriptions = new Dictionary<string, string> {
        ...
        { "guobiao/kshen", "K神改版国标麻将，新增镜同、四连刻等番种，复合番100封顶，默认8番起和。小牌点炮无责：点和12分以下三家各付n；12分以上两家各付12，放铳者付3n-24。自摸三家各付n。可开启错和、可自定义起和番。出现计分bug可在群里向q975653345反馈" },
        ...
        { "jiandan/standard", "南雀规则由南瓜饼编写，是一个正在测试的规则，目标是在新手易上手与竞技策略深度之间取得平衡。无起和限制。当前版本固定采用一人和牌即止。标准规则将采用三人和牌（血战到底），正在开发中。" },
        { "hongque/v1.6", "虹雀² v1.6 可玩原型：使用126张彩色数字牌，按环状花色等级与数字公差组成顺子、刻子和彩虹。当前版本纯内存运行，不统计数据、不保存牌谱；计分仅实现规则底分，供验证核心行牌与多面亮牌。" },
        { "taiwan/standard", "台湾麻将：使用144张牌与16张手牌，按台计分，支持公开报听、食替限制与八仙过海等规则。具体流程与台表可在馆规设置中选择。" },
